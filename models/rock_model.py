...
class RockModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--solid_ct', type=float, default=2232.875, help='the ct value of dry rock')
        parser.add_argument('--water_ct', type=float, default=0, help='the ct value of pure water')
        parser.add_argument('--air_ct', type=float, default=-1000, help='the ct value of pure air')
    ...
    def __init__(self, opt):
        ...
        self.netG = networks.define_G_percent(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
                                      not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, opt.solid_ct, opt.water_ct, opt.air_ct)
    ...
    def forward(self):
        ...
        self.fake_B, self.percent = self.netG(self.real_A)  # G(A)
